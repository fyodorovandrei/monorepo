...
This package extends the functionality of [`@twa.js/init-data`](twa-js-init-data), including all
...
You can learn more about parsing utilities in [`@twa.js/init-data`](twa-js-init-data#parsing)
documentation.
...
duration is set to 1 day (86,400 seconds). It is recommended to always check the expiration of
the initialization data, as it could be stolen but still remain valid. To disable this feature,
