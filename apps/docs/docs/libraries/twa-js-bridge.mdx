...
[//]: # ()
[//]: # ()
[//]: # (As long as the package provides only low-level control, we recommend using [SDK]&#40;twa-js-sdk/about&#41; which implements package methods. It also provides additional some automatic parameters checks, more intuitive method names, and easier usage.)